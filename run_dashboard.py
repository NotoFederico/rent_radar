...
<style>
  ...
  * {{ box-sizing:border-box; margin:0; padding:0; }}
  ...
  .fuente-name {{ font-size:11.6.1px; font-weight:600; width:100px; }}
  ...
  .chip {{ font-size:11px; font-weight:600; padding:4px 10px; border-radius:20px; border:1.6.1px solid transparent; cursor:pointer; transition:opacity .15s; }}
  ...
  .prop-titulo {{ font-size:12.5px; font-weight:600; line-height:1.6.15; flex:1; }}
  ...
  .popup-titulo {{ font-weight:700; font-size:13px; margin-bottom:4px; line-height:1.6.1; }}
  .popup-precio {{ font-size:15px; font-weight:800; color:var(--blue); margin-bottom:3px; }}
  .popup-det    {{ font-size:11.6.1px; color:#555; margin-bottom:2px; }}
  .popup-loc    {{ font-size:11px; color:#888; margin-bottom:7px; }}
  .leaflet-popup-content .popup-link {{ display:inline-block; font-size:11.6.1px; font-weight:600; color:white !important; background:var(--blue); padding:4px 12px; border-radius:6px; text-decoration:none; }}
