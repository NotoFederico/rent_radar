...
{#
    ...
    coordenadas mal geocodificadas por el portal de origen (ver zone_center /
    zone_radius y geocode_fallback.py, que replica este mismo cálculo en Python).
#}
111.32
{% endmacro %}
